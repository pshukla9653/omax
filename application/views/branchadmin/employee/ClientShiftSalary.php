    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-2">
          <h3 class="content-header-title mb-0">Client Shiftwise Salary</h3>
      ...
      <div class="content-body">
        ...
        <div class="row">
                   ...
                   <?php echo form_open_multipart('Reports/ListOfClientShiftSalary', array('name'=>'ListOfSalaryAsClient'));?>
                   <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                           <div class="form-group">
                                ...
                                <select name="client_id" class="form-control select2" id="SalaryTypeReport" required>
                                <option value="">Select</option>
            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-header">
                  <h4 class="card-title">Client Shiftwise Salary List</h4>
