                  ...
                  <div class="card-block card-dashboard">
                    ...
                    <table class="table table-striped table-bordered dataex-html5-selectors">
                      ...
                      <tbody>
						  ...
						  <?php  
						  $i = 0;
						  foreach ($salaryList as $ids=>$item): ?>
                          <?php if ($ids==0){?>
                                 <tr>
                                      <td><?=++$i?></td> 
                                      <td rowspan="<?php echo count($salaryList);?>" style="vertical-align:middle;"><?=$item['emp_id']?></td>
                                      <td rowspan="<?php echo count($salaryList);?>" style="vertical-align:middle;"><?=$item['emp_code']?></td>
                                      <td rowspan="<?php echo count($salaryList);?>" style="vertical-align:middle;"><?php
                                      $getEmpName = $this->CommanModel->getDataIfdataexists('emp_name','tbl_employee',array('id'=>$item['emp_id']));
									  echo $getEmpName['emp_name'];
									  ?></td>
                                      
                                      <td rowspan="<?php echo count($salaryList);?>" style="vertical-align:middle;">
                                              <?php 
                                       ...
                                       <td rowspan="<?php echo count($salaryList);?>" style="vertical-align:middle;"></td>
                                        <td rowspan="<?php echo count($salaryList);?>" style="vertical-align:middle;">
                                              <?php 
                                      ...
                                      foreach ($AllowanceList as $allowance): 
                                          ...
                                          foreach($payableall as $allawan){
                                            ...
                                            if($allowance['id'] == $Detailallwance[0]){
                                              ...
                                              $allAllowance['id'][]  =  $alloaanceamount;
											  break;
                                            }
                                            else{
                                              $alloaanceamount =  0;
                      ...
                      <tr>
                          ...
                          <?php foreach ($AllowanceList as $allowance): ?>
                                      <th><?=array_sum($allAllowance['id']);?></th>
