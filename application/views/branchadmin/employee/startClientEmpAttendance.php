    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-2">
          <h3 class="content-header-title mb-0">Client / Employee Attendance</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a>
                </li>
                <li class="breadcrumb-item"><a href="#">Client /  Start Employee Attendance</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-xl-12 col-lg-12">
              ...
              <div class="card">
                ...
                <div class="card-body collapse in">
                  ...
                  <?php echo form_open_multipart('branchadmin/UploadExcels/attendanceStartOfClientEmp', array('name'=>'attendanceStartOfClientEmp'));?>
                  ...
                  <input type="hidden" name="service" value="<?php echo $service_id;?>"/>
                   <div class="horizontal-scroll scroll-example">
                    ...
                    <table class="table table-striped table-bordered compact">
                      ...
                      <td>
                      <select name="att[<?php echo $emp['id'];?>][<?php echo $date;?>]" style="width:60px !important;" class="form-control" <?php echo $attandence[0]['locked_status']=='1'?'disabled':'';?>>
                      <option value="P" <?php echo $attandence[0]['day'.$date]==''?'Selected':'';?>> </option>
                      ...
                      <?php }?>
                      <td style="width:10px;">
                     <input type="text" name="ot_days[<?php echo $emp['id']; ?>]" class="form-control" value="<?php echo $attandence[0]['ot_days'];?>" />
                      </td>
                      <td style="width:80px;">
