    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-2">
          <h3 class="content-header-title mb-0">Export/Import HDFC</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a>
                </li>
                <li class="breadcrumb-item"><a href="#">Export/Import HDFC</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Export/Import HDFC</h4>
                </div>
                <div class="card-body">
                  <div class="card-block">
                   ...
                   <div class="col-md-12">
                    <!-- <a href="<?php echo base_url('branchadmin/UploadExcels/attendanceExportExcelForSelfEmp')?>" class="btn btn-success btn-sm">Download Excel</a></p> -->
                             ...
                             <?php $data=array('class'=>'form-inline'); echo form_open_multipart('branchadmin/UploadExcels/uploadHDFC', $data);?>
                       </div> 
                            <div class="col-md-3">
