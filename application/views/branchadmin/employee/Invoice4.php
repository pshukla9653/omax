...
/*.footer{
 ...
 <table style="width:21cm !important;" border="1" class="table-bordered">
                   ...
                   <th rowspan="2">RATE</th>
                    ...
                    <td><?php echo $payment[3];?></td>
                     ...
                     <td><?php echo round($payment[15]);?></td>
                      <td><?php $cgst = explode('@', $payment[16]); echo round($cgst[1]);?>%</td>
                      <td><?php $cgst = explode('@', $payment[16]); echo round($cgst[0]);?></td>
                      <td><?php $sgst = explode('@', $payment[17]); echo round($sgst[1]);?>%</td>
                      <td><?php $sgst = explode('@', $payment[17]); echo round($sgst[0]);?></td>
                      <td><?php $igst = explode('@', $payment[18]); echo round($igst[1]);?>%</td>
                  ...
                  <th style="text-align:center !important;"><?php $cgst = explode('@', $paymentdetail[1][16]); echo round($cgst[1]);?>%</th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][5]);?></th>
                  <th style="text-align:center !important;"><?php $cgst = explode('@', $paymentdetail[1][17]); echo round($cgst[1]);?>%</th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][6]);?></th>
                  <th style="text-align:center !important;"><?php $cgst = explode('@', $paymentdetail[1][18]); echo round($cgst[1]);?>%</th>
