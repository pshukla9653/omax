                   ...
                   <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php foreach($ClientList as $client){?>
                                 <option value="<?php echo $client['id'];?>" <?php if($client['id'] == $emp['client_id']) { ?> selected<?php } ?>><?php echo $client['client_name'];?></option>
                                <?php }?>
                                </select>
                  ...
                  <div class="card-block card-dashboard">
                    ...
                    <table class="table table-striped table-bordered compact table-responsive">
                      ...
                      <th>Action</th>
								  ...
								  $clientname = $this->CommanModel->getDataIfdataexists('id, client_name','tbl_client',array('id'=>$loan['client_id']));
