          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Update Bank (For Company Use)</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Update Bank (For Company Use)</h4>
                </div>
                <div class="card-body">
                  <div class="card-block">
                   <div class="row">
                   <div class="col-xl-12 col-lg-12">
                   <?php echo form_open_multipart('branchadmin/Setting/editBank/'.$editbank[0]['id'], array('name'=>'addBank'));?>
                   <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$editbank[0]['bank_name'], 'placeholder'=>'Bank Name', 'name' => 'bank_name')); ?>
								<input type="hidden" name="bank_name_hidden" value="<?php echo $editbank[0]['bank_name'];?>"/>
                     ...
                     <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option value="1" <?php echo $editbank[0]['status']==1?'selected':'';?>>Active</option>
                                <option value="0" <?php echo $editbank[0]['status']==0?'selected':'';?>>Inactive</option>
                                </select>
