          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Update Leave</a>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-block">
                   <div class="row">
                   <div class="col-xl-12 col-lg-12">
                   <?php echo form_open_multipart('branchadmin/Setting/editLeave/'.$editleave[0]['id'], array('name'=>'addLeave'));?>
                   <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$editleave[0]['leave_name'], 'placeholder'=>'Leave Name', 'name' => 'leave_name')); ?>
								<input type="hidden" name="leave_name_hidden" value="<?php echo $editleave[0]['leave_name'];?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$editleave[0]['sort_name'], 'placeholder'=>'Leave Sort Name', 'name' => 'sort_name')); ?>
                     ...
                     <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option value="1" <?php echo $editleave[0]['status']==1?'selected':'';?>>Active</option>
                                <option value="0" <?php echo $editleave[0]['status']==0?'selected':'';?>>Inactive</option>
                                </select>
