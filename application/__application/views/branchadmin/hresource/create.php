              ...
              <div class="card">
                ...
                <div class="card-body collapse in">
                  <div class="card-block">
                     ...
                     <?php echo form_open_multipart('branchadmin/Hresource/createConvertEmployee/'.$applicant_details['id'], array('class'=>'steps-validation wizard-circle', 'name'=>'emp'));?>
                     <?php echo $this->session->flashdata('msg'); ?>
                      ...
                      <fieldset>
                        <div class="row">
                          ...
                          <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control required', 'value'=>$empcode, 'placeholder'=>'Employee Code', 'name' => 'emp_code')); ?>
								<?php echo form_error('emp_code', '<p class="text-danger">', '</p>'); ?>
                            </div>
                           <div class="form-group">
								<?php echo form_label('Employee Name <span class="danger">*</span>'); ?>
                                <?php echo form_input(array('class'=>'form-control required', 'value'=>$applicant_details['applicant_name'], 'placeholder'=>'Employee Name', 'name' => 'emp_name')); ?>
								<?php echo form_error('emp_name', '<p class="text-danger">', '</p>'); ?>
                            </div>
                            <div class="form-group">
								<?php echo form_label('Date of Birth'); ?>
                                <?php echo form_input(array('class'=>'form-control required', 'value'=>$applicant_details['dob'], 'placeholder'=>'dd/mm/yyyy', 'name' => 'dob','id'=>'date')); ?>
								<?php echo form_error('dob', '<p class="text-danger">', '</p>'); ?>
                            </div>
                            <div class="form-group">
								<?php echo form_label('Gender'); ?>
                               <?php /*?> <?php echo form_dropdown(array('class'=>'form-control', 'value'=>set_value('gender'), 'name' => 'gender'),array(''=>'Select','Male'=>'Male','Female'=>'Female')); ?><?php */?>
                                <select class="form-control" name="gender">
                                <option selected>select</option>
                                  <option value="Male" <?php if($applicant_details['gender'] == 'Male') {?> selected <?php } ?>>Male</option>
                                  <option value="Female" <?php if($applicant_details['gender'] == 'Female') {?> selected <?php } ?>>Female</option>
                                </select>
                          ...
                          <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control required', 'value'=>$applicant_details['mobile'], 'placeholder'=>'99999999999', 'name' => 'mobile','id'=>'mobile')); ?>
                      ...
                      <fieldset>
                        <div class="row">
                          ...
                          <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control required', 'value'=>set_value('p_police_station'), 'placeholder'=>'Police Station', 'name' => 'p_police_station','id'=>'p_police_station')); ?>
								<?php echo form_error('p_police_station', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
								<?php echo form_label('District'); ?>
                                <?php echo form_input(array('class'=>'form-control required', 'value'=>set_value('p_dist'), 'placeholder'=>'District', 'name' => 'p_dist','id'=>'p_dist')); ?>
                      ...
                      <fieldset>
                        <div class="row">
                          ...
                          <td><input type="text" class="form-control" name="ref_person_mbile<?php echo $i;?>" /></td>
                      ...
                      <fieldset>
                        <div class="row">
                          ...
                          <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$joindate['appointmentdate'], 'placeholder'=>'dd/mm/yyyy', 'name' => 'doj','id'=>'date','required'=>'required')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <option value="<?php echo $grade['id'];?>" <?php if($joindate['grade'] == $grade['id']) {?>selected<?php }?> ><?php echo $grade['grade_name'];?></option>
                                <?php endforeach;?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <option value="<?php echo $empdepart; ?>"><?php echo $empdepart; ?></option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <option value="<?php echo $applicant_post['post_offered'];?>"><?php echo $applicant_post['post_offered'];?></option>
