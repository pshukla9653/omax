              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-block">
                   <div class="row">
                   <div class="col-xl-12 col-lg-12">
                   <?php echo form_open_multipart('branchadmin/Setting/addDepartment', array('name'=>'addDepartment'));?>
                   <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>set_value('department_name'), 'placeholder'=>'Department Name', 'name' => 'department_name','autofocus'=>'autofocus')); ?>
