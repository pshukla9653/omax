          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Update Allowance</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Update Allowance</h4>
                </div>
                <div class="card-body">
                  <div class="card-block">
                   <div class="row">
                   <div class="col-xl-12 col-lg-12">
                   <?php echo form_open_multipart('branchadmin/Setting/editAllowance/'.$editincome[0]['id'], array('name'=>'addAllowance'));?>
                   <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$editincome[0]['allowance_name'], 'placeholder'=>'Allowance Name', 'name' => 'allowance_name')); ?>
								<input type="hidden" name="allowance_name_hidden" value="<?php echo $editincome[0]['allowance_name'];?>"/>
                             ...
                             <div class="col-md-6">
                                ...
                                <option value="1" <?php echo $editincome[0]['mode_of_payment']==1?'selected':'';?>>Fixed</option>
                                <option value="0" <?php echo $editincome[0]['mode_of_payment']==0?'selected':'';?>>Payable</option>
                                </select>
                     ...
                     <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option value="1" <?php echo $editincome[0]['status']==1?'selected':'';?>>Active</option>
                                <option value="0" <?php echo $editincome[0]['status']==0?'selected':'';?>>Inactive</option>
                                </select>
