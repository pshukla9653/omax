              ...
              <script>
                ...
                <div class="card-body">
                  <div class="card-block">
                   <div class="row">
                   <div class="col-xl-12 col-lg-12">
                   <?php echo form_open_multipart('Web/transactionDetail/'.$client_id.'/'.$totalamount['year_v'].'/'.$totalamount['month_v'], array('name'=>'addBankBranch'));?>
                   <div class="col-md-12">
                             ...
                             <div class="col-md-6">
                                ...
                                <?php $name = $this->CommanModel->getDataIfdataexists('client_name','tbl_client',array('id'=>$totalamount['client_id']));?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="invoiceno"  value="<?php echo $totalamount['invoice_no']?>" />
								<?php echo form_error('totalamount', '<p class="text-danger">', '</p>'); ?>
                            </div>
                            <div class="form-group">
								<?php echo form_label('Total Amount'); ?>
                                <input type="text" class="form-control" readonly name="totalamount" id="totalamt" value="<?php echo $totalamount['total_amount']?>" />
								<?php echo form_error('totalamount', '<p class="text-danger">', '</p>'); ?>
                            </div>
                            <div class="form-group">
								<?php echo form_label('Paid Amount'); ?>
                                <input type="text" class="form-control" readonly name="paidamount"  value="<?php echo $totalamount['paid_amount']?>" id="paidamt"/>
								<?php echo form_error('dueamount', '<p class="text-danger">', '</p>'); ?>
                            </div>
                            <div class="form-group">
								<?php echo form_label('Due Amount'); ?>
                                <input type="text" class="form-control" readonly name="dueamount"  value="<?php echo $totalamount['due_amount']?>" id="dueamt"/>
								<?php echo form_error('dueamount', '<p class="text-danger">', '</p>'); ?>
                            </div>
                            <input type="hidden" value="<?php echo $totalamount['due_amount']?>"  id="damount">
                           ...
                           <div class="form-group">
                            ...
                            <br>
                            <?php if($totalamount['payment_status'] != 'Paid'){?>
