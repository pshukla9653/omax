          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Update Designation</a>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-block">
                   <div class="row">
                   <div class="col-xl-12 col-lg-12">
                   <?php echo form_open_multipart('branchadmin/Setting/editDesignation/'.$editdesignation[0]['id'], array('name'=>'addDesignation'));?>
                   <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$editdesignation[0]['designation_name'], 'placeholder'=>'Designation Name', 'name' => 'designation_name')); ?>
								<input type="hidden" name="designation_name_hidden" value="<?php echo $editdesignation[0]['designation_name'];?>"/>
                            ...
                            <div class="form-group">
                                       ...
                                       <?php echo form_textarea(array('class'=>'form-control', 'value'=>$editdesignation[0]['description'],  'placeholder'=>'Description', 'name' => 'description')); ?>
                     ...
                     <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option value="1" <?php echo $editdesignation[0]['status']==1?'selected':'';?>>Active</option>
                                <option value="0" <?php echo $editdesignation[0]['status']==0?'selected':'';?>>Inactive</option>
                                </select>
