          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Add Grade</a>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-block">
                   <div class="row">
                   <div class="col-xl-12 col-lg-12">
                   <?php echo form_open_multipart('branchadmin/Setting/addGrade', array('name'=>'addGrade'));?>
                   <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>set_value('grade_name'), 'placeholder'=>'Grade Name', 'name' => 'grade_name','autofocus'=>'autofocus')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>set_value('nature_of_work'), 'placeholder'=>'As', 'name' => 'nature_of_work')); ?>
