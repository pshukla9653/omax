...
/*.footer{
 ...
 <table style="width:21cm !important;" border="1" class="table-bordered">
                   ...
                   <tr>
                    ...
                    <th>UOM</th>
                    <th>TO. BASIC AMT</th>
                    <th>EPF <br>@<br> <?php $epf = explode('@', $paymentdetail[1][12]); echo $epf[1].'%';?></th>
                    <th>ESIC <br>@<br> <?php $epf = explode('@', $paymentdetail[1][13]); echo $epf[1].'%';?></th>
                    <th>S.C. <br>@<br> <?php $epf = explode('@', $paymentdetail[1][14]); echo $epf[1].'%';?> ON <br>BASIC<br> WAGES</th>
                    <th>TOTAL <br>TAXEBLE<br> VALU</th>
                    <th>CGST <br>@<br> <?php $cgst = explode('@', $paymentdetail[1][16]); echo $cgst[1].'%';?></th>
                    <th>SGST <br>@<br> <?php $sgst = explode('@', $paymentdetail[1][17]); echo $sgst[1].'%';?></th>
                    <th>IGST <br>@<br> <?php $igst = explode('@', $paymentdetail[1][18]); echo $igst[1].'%';?></th>
                    <th>TOTAL <br>GST</th>
                    ...
                    <td><?php echo $payment[3];?></td>
                     ...
                     <td><?php echo round($payment[11]);?></td>
                     <td><?php $epf = explode('@', $payment[12]); echo round($epf[0]);?></td>
                     <td><?php $esic = explode('@', $payment[13]); echo round($esic[0]);?></td>
                     <td><?php $sc = explode('@', $payment[14]); echo round($sc[0]);?></td>
                     <td><?php echo round($payment[15]);?></td>
                      <td><?php $cgst = explode('@', $payment[16]); echo round($cgst[0]);?></td>
                      <td><?php $sgst = explode('@', $payment[17]); echo round($sgst[0]);?></td>
                      <td><?php $igst = explode('@', $payment[18]); echo round($igst[0]);?></td>
                     <td><?php echo round($payment[19]);?></td>
                     <td><?php echo round($payment[20]);?></td>
                    </tr>
                    <?php  }?>
                  <tr>
                  <th colspan="5" style="text-align:center !important;">TOTAL</th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][0]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][1]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][2]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][3]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][4]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][5]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][6]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][7]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][8]);?></th>
                  <th style="text-align:center !important;"><?php echo round($totalpayment[1][9]);?></th>
                   ...
                   <tr>
                    ...
                    <td style="width:55%;">
                    <table style="width:100%; font-size:12px!important;" class="table-bordered">
                    <tr><td>TOTAL AMOUNT BEFORE GST</td> <td style="text-align:center !important;"><?php echo round($totalpayment[1][0]);?></td></tr>
                    <tr><td>ADD: CGST</td> <td style="text-align:center !important;"><?php echo round($totalpayment[1][5]);?></td></tr>
                    <tr><td>ADD: SGST</td> <td style="text-align:center !important;"><?php echo round($totalpayment[1][6]);?></td></tr>
                    <tr><td>ADD: IGST</td> <td style="text-align:center !important;"><?php echo round($totalpayment[1][7]);?></td></tr>
                    <tr><td>TOTAL AMOUNT: GST</td> <td style="text-align:center !important;"><?php echo round($totalpayment[1][8]);?></td></tr>
                   ...
                   1. Bill are strictly payable within 7 days from date of submission of bill.<br>
                    ...
                    <td style="width:55%;">
                    <table style="width:100%; font-size:12px!important;" class="table-bordered">
                    <tr><td>TOTAL AMOUNT AFTER TAX</td> <td style="text-align:center !important;"><?php echo round($totalpayment[1][9]);?></td></tr>
