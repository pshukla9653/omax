 ...
 <table style="width:21cm !important;" border="1" class="table-bordered">
                   ...
                   <tr>
                    ...
                    <td><?php echo $payment[3];?></td>
                     ...
                     <td><?php $epf = explode('@', $payment[12]); echo $epf[0];?></td>
                     <td><?php $esic = explode('@', $payment[13]); echo $esic[0];?></td>
                  ...
                  <th style="text-align:center !important;"><?php echo $totalpayment[1][1];?></th>
                  <th style="text-align:center !important;"><?php echo $totalpayment[1][2];?></th>
