            ...
            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
              ...
              <div class="card-body collapse in">
                ...
                <div class="card-block">
                  <?php echo form_open_multipart('web/login', array('name'=>'login','class'=>'form-horizontal'));?>
                    <fieldset class="form-group position-relative has-icon-left">
                      <input type="text" class="form-control" id="user-name" name="username" placeholder="Enter Username or Mobile Number"
                      required autofocus>
