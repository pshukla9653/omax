                  ...
                  <table class="table table-striped table-bordered dataex-html5-selectors">
                    ...
                    <tbody>
                      <?php 
                            ...
                            $getInv  =	$this->CommanModel->getListWhereLimit('id,client_id,invoice_no,payment_status,total_amount,paid_amount,due_amount,year_v,month_v','t bl_client_invoice','id','DESC', array('company_id'=>$this->session->userdata('company_id'), 'branch_id'=>$this->session->userdata('branch_id')),'5');
